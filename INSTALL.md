...
curl -L -o dblift-macos-arm64.tar.gz \
  https://github.com/yourorg/dblift/releases/latest/download/dblift-macos-arm64.tar.gz
...
curl -L -o dblift-macos-x64.tar.gz \
  https://github.com/yourorg/dblift/releases/latest/download/dblift-macos-x64.tar.gz
...
### Windows
1. Download: https://github.com/yourorg/dblift/releases/latest/download/dblift-windows-x64.zip
